...
public class BoardController extends HttpServlet {
		...
		try {
			...
			} else if(action.equals("/addReply.do"))
			{
				...
				pw.print("<script>"+" alert('답글을 추가했습니다.');"
						...
						+ articleNO + "';" + "</script>");
				return;
			}else if(action.equals("/listArticleMember.do"))	//각 회원마다 게시물 갯수
			{
				articlesList = boardService.listArticleMember();
				request.setAttribute("articleMember", articlesList);
				nextPage="/board01/listArticleMember.jsp";
			}
	...
	private Map<String, String> upload(HttpServletRequest request, HttpServletResponse response)
		...
		File currnetDirPath = new File(ARTICLE_IMAGE_REPO);
