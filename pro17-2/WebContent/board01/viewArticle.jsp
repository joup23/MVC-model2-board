...
<c:if  var="imageThere" test="${not empty article.imageFileName && article.imageFileName!='null' }">
</c:if>
<!DOCTYPE html>
<html>
<head>
...
<body>
	<form name="frmArticle" method="post" enctype="multipart/form-data"
		...
		<table border="0" align="center">
			...
			<tr>
				<td width="20%" align="center" bgcolor="#FF9933">글 내용</td>
